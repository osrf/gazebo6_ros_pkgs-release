## gazebo6_ros_pkgs (jade) - 2.5.1-3

The packages in the `gazebo6_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --ros-distro jade gazebo6_ros_pkgs --edit` on `Tue, 15 Sep 2015 20:12:35 -0000`
...
## gazebo6_ros_pkgs (indigo) - 2.4.9-1

The packages in the `gazebo6_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo gazebo6_ros_pkgs --edit` on `Tue, 15 Sep 2015 20:01:14 -0000`
...
## gazebo6_ros_pkgs (jade) - 2.5.1-2

The packages in the `gazebo6_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade gazebo6_ros_pkgs` on `Mon, 17 Aug 2015 16:13:47 -0000`
...
## gazebo6_ros_pkgs (jade) - 2.5.1-1

The packages in the `gazebo6_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade gazebo6_ros_pkgs --edit` on `Sun, 16 Aug 2015 01:34:19 -0000`
...
## gazebo6_ros_pkgs (indigo) - 2.4.9-0

The packages in the `gazebo6_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo gazebo6_ros_pkgs --edit` on `Sun, 16 Aug 2015 01:20:50 -0000`
...
## gazebo6_ros_pkgs (jade) - 2.5.1-0

The packages in the `gazebo6_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade gazebo6_ros_pkgs` on `Sun, 16 Aug 2015 00:58:47 -0000`
...
The packages in the `gazebo6_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --ros-distro jade gazebo6_ros_pkgs --edit` on `Wed, 12 Aug 2015 18:48:42 -0000`
...
The packages in the `gazebo6_ros_pkgs` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --ros-distro indigo gazebo6_ros_pkgs --edit` on `Wed, 12 Aug 2015 16:51:24 -0000`
